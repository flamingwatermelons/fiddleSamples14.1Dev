...
function ColorPickerByIndex(min, max) {
         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                overviewPlusDetailPaneBackgroundImageUri: "http://jp.dev.igniteui.local/14-1/images/samples/maps/world.png",
                series: [{
                    type: "geographicShape",
                    name: "worldCountries",
                    markerType: "none",
                    shapeMemberPath: "points",
                    shapeDataSource: 'http://jp.dev.igniteui.local/14-1/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'http://jp.dev.igniteui.local/14-1/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
